...
class PlayGroundTest {
    ...
    fun runIt() {
        ...
        val dateInString1 = "08-15-2023 09:30:00" // "08-15-2023 09:30:00" // "08-15-2023 09:30:00"
        val date1: Date = formatter.parse(dateInString1)
        println("S: " + date1.time * 1000000)

        val dateInString2 = "08-15-2023 10:30:00" // "08-15-2023 09:30:00" // "08-15-2023 09:30:00"
