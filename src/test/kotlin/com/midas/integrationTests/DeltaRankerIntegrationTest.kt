...
class DeltaRankerIntegrationTest {
    ...
    fun Can_rank_record_breaking_positive_deltas() {
        ...
        Assertions.assertEquals(18, ranking1.distance)
        Assertions.assertEquals(newPriceDelta, ranking1.priceDelta)
        Assertions.assertEquals(15, ranking1.timeWindow)
        ...
        Assertions.assertEquals(19, rankings2[0].distance)
        ...
        Assertions.assertEquals(10, rankings2[2].timeWindow)
        Assertions.assertEquals(5, rankings2[3].timeWindow)
    ...
    fun Can_rank_with_multiple_tickers() {
        ...
        for (r in results) {
            println("ticker: ${r.ticker}, delta: ${r.priceDelta}, probability: ${r.probabilityCoefficient}, window: ${r.timeWindow}, distance: ${r.distance}")
        }
